...
TypeScript bindings are generated from Rust structs by running `cargo test`, and live in `ui/src/bindings`.  In the future, these could theoretically follow a similar approach to the back-end instead of being defined in a single place.
